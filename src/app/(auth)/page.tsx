      ...
      <div className="container h-full flex justify-center items-center">
        <div className="w-full max-w-sm bg-white py-11 px-6 sm:p-11 shadow-md rounded-md">
          <form className="w-full">
            ...
            <Link href="/" className="text-xs text-green-color mt-5">Forgot Password?</Link>
            <div className="mt-3">
              <Link href="/dashboard">
                <Button>
            ...
            <p className="text-xs mt-5">
              By logging in, you agree to our <Link href="/" className="text-green-color">terms and conditions</Link>.
            </p>
            <p className="text-xs mt-2">
              Don't have a Vargent account yet? <Link href="/signup" className="text-green-color">Create an account</Link>
            </p>
          </form>
        </div>
      </div>
