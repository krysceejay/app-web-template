      ...
      <div className="container h-full flex justify-center items-center">
        <div className="w-full max-w-sm bg-white py-11 px-6 sm:p-11 shadow-md rounded-md">
          <form className="w-full">
            ...
            By continuing, you agree to our <Link href="/" className="text-green-color">terms and conditions</Link>.
            </p>
            <p className="text-xs mt-2">
            Already have a Vargent account? <Link href="/" className="text-green-color">Log in here</Link>
            </p>
          </form>
        </div>
      </div>
