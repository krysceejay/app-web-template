    ...
    <div className="w-3/5 mx-auto">
            <div className="flex justify-between items-center">
              ...
              <div 
                ...
                <p className="text-xs font-semibold mt-2.5">Confirm & Pay</p>
              </div>
            </div>
            <div className="mt-8">
              ...
              <div className="mt-5 flex space-x-2.5">
                <div className="flex-1 border border-dashed border-[#D7D7D7] rounded flex flex-col justify-center items-center p-4">
                ...
                <div 
                className="flex-1 border border-[#D7D7D7] rounded flex flex-col justify-center items-center p-4 cursor-pointer"
                onClick={() => goTo(2)}>
                ...
                <div className="flex-1 border border-[#D7D7D7] rounded flex flex-col justify-center items-center p-4 cursor-pointer"
                onClick={() => goTo(2)}>
                  <div className="w-[38px] h-[38px] rounded-full bg-[#2872A7] flex justify-center items-center">
